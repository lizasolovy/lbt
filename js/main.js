...
(function () {
  ...
  const menuItems = (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelectorAll('[data-menu-item]'); // const overlay = document?.querySelector('[data-menu-overlay]');
...
const isTablet = () => {
  if (window.innerWidth >= 780 && window.innerWidth <= 1024) {
    return true;
  }
